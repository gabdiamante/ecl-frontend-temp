...
(function(Wkt) {
    ...
    Wkt.Wkt.prototype.deconstruct = function(obj, multiFlag) {
            ...
            if (multiFlag === undefined) {
                multiFlag = (function() {
                    ...
                    if (l === 2) {
                        ...
                        if (
                            sign(obj.getPaths().getAt(0)) *
                                sign(obj.getPaths().getAt(1)) <
                            0
                        ) {
                    ...
                    if (
                        areas.indexOf(areas[0]) !== areas.lastIndexOf(areas[0])
                    ) {
        ...
        console.log(
            'The passed object does not have any recognizable properties.'
        );
    };
})(Wkt || require('./wicket'));
