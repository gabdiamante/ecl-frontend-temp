const TABLES = {
    users : {
        columnDefs : [
            { width: 50, headerCellTemplate: `<input type="checkbox" ng-model="vm.checkbox" ng-change="vm.toggleCheckRoleUserAll(vm.checkbox,'roleUserCheck', '')">`, 
            ...
            { name: 'avatar', displayName: 'Avatar', cellTemplate: `<div class="img-con"><img class="img-res" ng-src="{{COL_FIELD}}"></div>`, width:75 },
    ...
    couriers : {
        columnDefs : [
            { name: 'name', displayName: 'Name', cellTemplate:`<a ui-sref="row.entity.id">{{COL_FIELD}}</a>` },
