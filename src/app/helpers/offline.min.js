        ...
        (c = {
            checks: {
                xhr: {
                    url: function() {
                        return (
                            '/favicon.ico?_=' + Math.floor(1e9 * Math.random())
                        );
                    },
                    timeout: 5e3
                },
        ...
        (d = Offline.reconnect = {}),
            ...
            (e = function() {
                ...
                return (
                    ...
                    (d.remaining = d.delay =
                        null !=
                        (a = Offline.getOption('reconnect.initialDelay'))
                            ? a
                            : 3)
                );
            }),
            ...
            (l = function() {
                ...
                return (
                    ...
                    null != Offline.reconnect &&
                        ...
                        (h = function(a) {
                            return (
                                a.preventDefault(), Offline.reconnect.tryNow()
                            );
                        }),
            ...
            (j = function() {
                return (
                    ...
                    Offline.on('reconnect:connecting', function() {
                        return (
                            d('offline-ui-connecting'), k('offline-ui-waiting')
                        );
                    }),
