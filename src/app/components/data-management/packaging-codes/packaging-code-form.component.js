...
(function() {
    ...
    angular.module('app').component('packagingCodeFormModal', {
        template: require('./packaging-code-form.html'),
        controller: PackagingCodeFormModalCtrl,
        controllerAs: 'vm',
        bindings: {
            modalInstance: '<',
            resolve: '<'
    ...
    PackagingCodeFormModalCtrl.$inject = [
        '$rootScope',
        '$state',
        '$cookies',
        '$scope',
    ...
    function PackagingCodeFormModalCtrl(
        $rootScope,
        $state,
        $cookies,
        $scope,
